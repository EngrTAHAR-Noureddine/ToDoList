...
class AddGoal extends StatelessWidget {
  ...
  void initState() {
    ...
    if((this.goal!=null)&&(this.goal.isNotEmpty))_goalName.text = this.goal;


    if((this.note!=null)&&(this.note.isNotEmpty)) _addNoteText.text = this.note;


    if((this.reason!=null)&&(this.reason.isNotEmpty))_addReason.text = this.reason;
  }
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope (
      onWillPop: () async{
        if(this.goal!=null && this.goal.isNotEmpty) {
